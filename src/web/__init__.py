...
* :mod:`web.loop` owns the one drawn-path control task.
* :mod:`web.experiment` owns the one teach/reversal/path task.
* :mod:`web.app` owns the HTTP surface and holds none of them directly.
